...
Я скачал топ-15 казахстанских приложений и написал [скрипт](https://github.com/OrderOfSixAngles/Android-permissions-chart), который строит bar chart по ним. Как видите, разрешения READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE и INTERNET очень популярны. Значит мы можем  менее болезнено встраивать наш код в большинство приложений.
