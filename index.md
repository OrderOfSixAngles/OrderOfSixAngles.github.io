...
Наш код готов, а значит пора его внедрять. Внедрять будем в основной Activity, мы ведь хотим, чтобы наш код запускался при открытии приложения

1. Скомпилировать их в smali код. Целевое же приложение надо декомпилировать, тоже до smali кода. Далее поместить свои классы, в папку с исходниками целевого приложения. Отредакти
