...
Google в курсе проблемы и собирается изменить READ_EXTERNAL_STORAGE в Android Q. Кому интересно, читаем [здесь](https://developer.android.com/preview/privacy/scoped-storage?hl=ru). Цитата:
